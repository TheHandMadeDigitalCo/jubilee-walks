...
class Application {
    constructor() {
        ...
        this._buttons = [
            new TrailToggleButton('1', this._mobileControls, this._walks[0].id, this._walks[0].colour),
            new TrailToggleButton('2', this._mobileControls, this._walks[1].id, this._walks[1].colour),
            new TrailToggleButton('3', this._mobileControls, this._walks[2].id, this._walks[2].colour),
            new TrailToggleButton('4', this._mobileControls, this._walks[3].id, this._walks[3].colour),
        ];
